...
pcall(function()
  ...
  game:service('VirtualInputManager'):SendKeyEvent(true, "Z", true, game)
  wait(0.1)
  game:service('VirtualInputManager'):SendKeyEvent(true, "Z", true, game)
  end
  if SkillX and DevilFruitMastery >= 2 then
  game:service('VirtualInputManager'):SendKeyEvent(true, "X", true, game)
  wait(0.2)
  game:service('VirtualInputManager'):SendKeyEvent(true, "X", true, game)
  end
  if SkillC and DevilFruitMastery >= 3 then
  game:service('VirtualInputManager'):SendKeyEvent(true, "C", true, game)
  wait(0.3)
  game:service('VirtualInputManager'):SendKeyEvent(true, "C", true, game)
  end
  if SkillV and DevilFruitMastery >= 4 then
  game:service('VirtualInputManager'):SendKeyEvent(true, "V", true, game)
  wait(0.4)
  game:service('VirtualInputManager'):SendKeyEvent(true, "V", true, game)
  end
  if SkillF and DevilFruitMastery >= 5 then
  game:GetService("VirtualInputManager"):SendKeyEvent(true, "F", true, game)
  wait(0.5)
  game:GetService("VirtualInputManager"):SendKeyEvent(true, "F", true, game)
  end
  end
    ...
    if _G.Ship then
        pcall(function()
            if CheckPirateBoat() then
                game:GetService("VirtualInputManager"):SendKeyEvent(true,32,true,game)
                wait(.5)
                game:GetService("VirtualInputManager"):SendKeyEvent(true,32,true,game)
        ...
        if _G.bjirFishBoat then
               pcall(function()
                    if CheckPirateBoat() then
                        ...
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,122,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,122,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        wait(.2)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,120,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,120,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        wait(.2)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,99,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,99,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        wait(.2)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,"C",true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                            if v:IsA("Tool") then
                        ...
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,99,true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        wait(.2)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",true,game.Players.LocalPlayer.Character.HumanoidRootPart)
                        wait(0.6)
                        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                            if v:IsA("Tool") then
...
while wait() do
    pcall(function()
        if AutoFarmAcient then
            game:GetService("VirtualInputManager"):SendKeyEvent(true,"Y",true,game)
            wait(0.1)
            game:GetService("VirtualInputManager"):SendKeyEvent(true,"Y",true,game)
        end
    end)
